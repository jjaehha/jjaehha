...
<div align="center">
  <h3>"Hello World"</h3>
  <h3>안녕하세요 풀스택 개발자를 꿈꾸고 있는 김재하입니다</h4>
</div>
...
## 🖥️ About Me
  ...
  - <div>
      <img src="https://img.shields.io/badge/Jayㅡ1105-371D1E?style=flat&logo=kakaotalk&logoColor=FFCD00"/>
      <img src="https://img.shields.io/badge/devㅡjay1-E4405F?style=flat&logo=instagram&logoColor=white"/>
...
> 문제 해결 경험
- 학원 개강 후 학원에서 처음 만난 수강생들과 처음으로 진행한 프로젝트이기 때문에 HTML, CSS를 처음 접해보는 팀원들이 있어 기존 생각한 기간보다 기간을 늘려 소외되는 인원 없이 하나하나 찾아보고 배우며 진행하였습니다.<br />
- 각 페어간 소통이 원활하지 못하여 팀장을 지정하여 소통문제를 해결 하였습니다. <br />
<br />
...
- 주요 개발 내용: <br />
  · 존윅 페이지 개발
- 회고 / 느낀점:<br />
  항상 클론 코딩을 하며 공부를 하다 처음으로 개발한 페이지입니다.<br />
  혼자 하는 만큼 분명히 어려운 점도 있었지만 해결했을 때 와 페이지를 완성했을 때의 성취감은 평생이 잊지 못할 것 같습니다.<br />
...
- GitHub 링크: https://github.com/jjaehha/FRADOT.git
- 개발 기간: 2023 .03 .31 ~ 2023. 05 .30
- 참여 인원: 5명
- 역할: 프로젝트 총괄, 디자인 구현, 인프라 찾기 부분 제작, About Us 제작
- 사용 기술:
  <img src="https://img.shields.io/badge/JavaScript-F7DF1E?style=flat&logo=javascript&logoColor=white"/>
  <img src="https://img.shields.io/badge/React-61DAFB?style=flat&logo=react&logoColor=white"/>
  <img src="https://img.shields.io/badge/Next.js-000000?style=flat&logo=nextdotjs&logoColor=white"/>
...
- 주요 개발 내용: <br />
  · FRADOT 서비스는 서울시 공공데이터를 사용하여 만든 웹사이트 입니다. <br />
  · 메인페이지 에서는 동네찾기와 인프라찾기 페이지 사용법을 간단히 설명하고 이동할 수 있도록 제작하였습니다. <br />
  · 동네찾기 페이지는 서울시 내에 사용자가 원하는 인프라를 갖춘 동네를 찾아주도록 제작하였습니다. <br />
  · 인프라찾기 페이지는 서울시 내에 사용자가 원하는 인프라의 위치 및 이름을 알려주도록 제작하였습니다. <br />
  · About Us 페이지는 저희를 간단히 소개 할 수 있는 페이를 만들었습니다<br />
- 회고 / 느낀점:<br />
  학원 강사님께 경진대회 관련 정보를 듣고 팀원들과 함께 진행하게 되었습니다.<br />
  학원 교육 과정 중 React 와 Next.js 가 있어 이번엔 HTML, CSS를 전혀 사용하지 않고 제작해 보기로 했습니다.<br />
  먼저 공공데이터를 둘러보며 주제를 정하던 중 편의 시설의 위치와 정보들이 있는 데이터들이 눈에 띄었습니다.<br />
  해당 데이터들을 활용하여 사용자가 원하는 여러 인프라 시설의 종류를 선택한 후 선택한 조건들이 모여있는 지역을 찾아주는 웹 사이트를 만들면 실용성이 높을 것이라고 판단하여 제작하게 되었습니다.<br />
  디자인은 피그마로 구현였고 로고는 저작권 관련 문제로 직접 제작하여 사용하였습니다.<br />
  개발을 하던 도중 위와 같은 크고 작은 문제들이 발생하였고 그런 문제들을 해결하며 많이 성장하고 팀장으로서 책임감도 배웠던 계기였습니다.<br />
  아쉽게 입상을 하진 못했지만 앞으로도 꾸준히 공부하며 기회가 된다면 팀원분들과 한 번 더 도전해 보고 싶습니다.<br />

> 문제 해결 경험 <br />
- 카카오에서 제공하는 open API를 사용하는데 공개되어 있는 next.js 와 react 관련 정보가 많이 없어 개발에 어려움이 있었지만 포기하지 않고 하나씩 진행해 보며 문제를 해결했습니다. <br />
- 서울 열린 데이터 광장에서 주최한 경진대회인 만큼 서울시 open API를 사용해야 했는데 제공하는 데이터들이 객체명이 일정하지 않고 비어있는 데이터도 존재하여 데이터를 가져와 바로 사용하기에는 문제가 있어 가져온 데이터를 새로운 객체로 만들어 개발 시간을 많이 단축했습니다. <br />
- 저희가 제공하고자 하는 서비스 특성상 많은 데이터를 카카오 맵에 불러와야 하지만 카카오 맵에서 무료 open API로는 제한적인 부분이 있어 한 번에 여러 개의 버튼을 누르게 되면 오류가 발생하였습니다. 이를 해결하고자 버튼 클릭 시 로딩이 진행되며 로딩 중 불필요한 데이터를 제거하여 오류를 해결할 수 있었습니다. <br />
<br />
